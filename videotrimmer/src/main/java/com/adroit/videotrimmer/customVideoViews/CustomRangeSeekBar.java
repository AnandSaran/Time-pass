package com.adroit.videotrimmer.customVideoViews;
...
import com.adroit.videotrimmer.R;
...
public class CustomRangeSeekBar extends View {
    ...
    private List<com.adroit.videotrimmer.customVideoViews.BarThumb> mBarThumbs;
    private List<com.adroit.videotrimmer.customVideoViews.OnRangeSeekBarChangeListener> mListeners;
    ...
    private void init() {
        mBarThumbs = com.adroit.videotrimmer.customVideoViews.BarThumb.initThumbs(getResources());
        mThumbWidth = com.adroit.videotrimmer.customVideoViews.BarThumb.getWidthBitmap(mBarThumbs);
        mThumbHeight = com.adroit.videotrimmer.customVideoViews.BarThumb.getHeightBitmap(mBarThumbs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mFirstRun) {
            for (int i = 0; i < mBarThumbs.size(); i++) {
                com.adroit.videotrimmer.customVideoViews.BarThumb th = mBarThumbs.get(i);
    ...
    public boolean onTouchEvent(@NonNull MotionEvent ev) {
        final com.adroit.videotrimmer.customVideoViews.BarThumb mBarThumb;
        final com.adroit.videotrimmer.customVideoViews.BarThumb mBarThumb2;
...
//                        checkPositionThumb(mBarThumb2, mBarThumb, dx, false, coordinate);
    ...
    private void checkPositionThumb(@NonNull com.adroit.videotrimmer.customVideoViews.BarThumb mBarThumbLeft, @NonNull com.adroit.videotrimmer.customVideoViews.BarThumb mBarThumbRight, float dx, boolean isLeftMove, float coordinate) {
    ...
    private void calculateThumbValue(int index) {
        if (index < mBarThumbs.size() && !mBarThumbs.isEmpty()) {
            com.adroit.videotrimmer.customVideoViews.BarThumb th = mBarThumbs.get(index);
    ...
    private void drawShadow(@NonNull Canvas canvas) {
        if (!mBarThumbs.isEmpty()) {
            ...
            for (com.adroit.videotrimmer.customVideoViews.BarThumb th : mBarThumbs) {
                if (th.getIndex() == 0) {
    ...
    public void addOnRangeSeekBarListener(com.adroit.videotrimmer.customVideoViews.OnRangeSeekBarChangeListener listener) {
    ...
    private void onCreate(CustomRangeSeekBar CustomRangeSeekBar, int index, float value) {
        ...
        for (com.adroit.videotrimmer.customVideoViews.OnRangeSeekBarChangeListener item : mListeners) {
    ...
    public List<com.adroit.videotrimmer.customVideoViews.BarThumb> getThumbs() {
        return mBarThumbs;
    }
}
