...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private ArrayList<RailBaseItemModel> mediaObjects = new ArrayList<>();
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        RailItemTypeTwoViewHolder holder = (RailItemTypeTwoViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
        thumbnail = holder.getRailBinding().imageViewPhoto;
        volumeControl = holder.getRailBinding().ivVolumeControl;
        viewHolderParent = holder.itemView;
        frameLayout = holder.getRailBinding().clMediaContainer;
        ...
        RailItemTypeTwoModel railTypeTwoModel = (RailItemTypeTwoModel) mediaObjects.get(targetPosition);
        String mediaUrl = railTypeTwoModel.getVideo();
        if (!mediaUrl.isEmpty()) {
    ...
    public void setMediaObjects(ArrayList<RailBaseItemModel> mediaObjects) {
